...
<div class="place">
    ...
    <div class="formbody">
    	...
    	<div class="clear"></div>
    	<form action="pages/sUser-doUpdate" method="post" onsubmit="return checkAll()">
        ...
        <table>
	    	<tr>
	    		<td class="dftr">编号：</td>
	    		<td><input name="sysUser.usrId" value="${sysUser.usrId }" type="text" class="dfinput"  readonly="readonly"><i>*</i></td>
	    		<td class="dftr">用户名：</td>
	    		<td><input name="sysUser.usrName" value="${sysUser.usrName }" type="text" class="dfinput" id="nameId" onblur="checkName()"><i id="nameId1">*必填项</i></td>
	    	</tr>
	    	<tr>
	    		<td class="dftr">现任角色：</td>
	    		<td><input name="sysUser.sysoRole.roleName" value="${sysUser.sysoRole.roleName}" type="text" class="dfinput" id="nameId" onblur="checklkmName()" readonly="readonly"><i>*</i></td>
	    		<td class="dftr">角色：</td>
	    		<td ><s:select id="roleId"  onblur="checkroleName()" list="request.sysRoleList" name="roleId" listKey="roleId" listValue="roleName" class="dfinput2">
