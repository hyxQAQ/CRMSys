...
$(document).ready(function(){
  ...
  $("#graph").toggle(
		  function(){
			  $("#graphpie").fadeIn("normal");
		  },
		  function(){
			  $("#graphpie").fadeOut("normal");
		  }
  );
...
<div class="place">
    ...
    <div class="tools">
       ...
       <!-- <li class="click" onclick="search()"><span><img src="<%=path %>/images/right/t06.png" /></span>查询</li> -->
        ...
        <li class="click" onclick="javascript:window.location='<%=path %>/pages/cManage-downloadExcel.action?judge=1'" ><span><img src="<%=path %>/images/right/t16.png" /></span>Excel</li>
       	<li class="click" onclick="javascript:window.location='<%=path %>/pages/cManage-downloadPdf.action?judge=1'" ><span><img src="<%=path %>/images/right/t17.png" /></span>Pdf文件</li>
        </ul>
    ...
    <table class="tablelist" >
        ...
        <tbody>
       	<s:if test="null == page || null == page.list || page.list.size<1">
	        <tr>
	        	<td colspan="3" align="center">无客户构成数据</td>
	        </tr> 
        </s:if>
        <s:else>
    ...
    <table style="display: none; margin-left: 180px;" id="graphpie" >
   		<tr>
   			<td><img src="<%=path %>/pages/cRank-chartClientConsist" /></td>
   		</tr>
   	</table> 
    <script type="text/javascript">
