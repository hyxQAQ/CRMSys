...
$(document).ready(function(){
	  ...
	  $(".chuli").click(function(){
		 ...
		 var id=$(this).next().val();
		  //alert(id);
		  location.href="<%=path%>/pages/cService-doDeal?clientService.svrId="+id;
	  });
});	  
//模糊查询提交表单
function search() {
    ...
    <li>服务处理</li>
     ...
     <div class="formbody">
        ...
        <tbody> 
	        ...
	        <tr>
	        <td colspan="7" align="center">无服务处理信息</td>
	        </tr> 
        	</s:if>
        	<s:else>
	        ...
	        <td> 
	        	...
	        	<img src="/CRMSys/images/right/t05.png" alt="处理" title="处理" class="chuli"/>
