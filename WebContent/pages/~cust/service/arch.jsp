    ...
    <div class="formbody">
    	...
    	<table>
	        	<tr>
	        		...
	        		<td>
		<%-- 				<select name="clientService.svrType">
        ...
        <tbody>  	
	        ...
	        <tr>
	        <td colspan="7" align="center">无服务归档信息</td>
	        </tr> 
        	</s:if>
        	<s:else>
	        ...
	        <td>${svrCreateDate }</td>
	        <td>
	        	<s:if test="svrStatus == 1">新创建</s:if>
	        	<s:elseif test="svrStatus == 2">已分配</s:elseif>
	        	<s:elseif test="svrStatus == 3">已处理</s:elseif>
	        	<s:else>已归档</s:else>
	        </td>
	        <td> 
	        	<img src="/CRMSys/images/right/t08.png" alt="查看" title="查看" onclick="window.location='<%=path%>/pages/cService-doArch?clientService.svrId=${svrId}'" />
	        </td>
	        </tr>
	        </s:iterator>
	        </s:else>   
