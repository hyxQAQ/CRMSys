...
<div class="place">
    ...
    <div class="formbody">
    	...
    	<div class="clear"></div>
    	<form action="pages/district-doUpdate?district.dsId=${district.dsId}" method="post" onsubmit="return checkAll()">
        ...
        <table>
	    	<tr>
	    		...
	    		<td ><input type="text" class="dfinput" name="district.dsName" value="${district.dsName}" id="nameId" onblur="checkName()"/><i id="nameId1">*必填项</i></td>
	    	</tr>
	    </table>
	    </form>
    </div>
